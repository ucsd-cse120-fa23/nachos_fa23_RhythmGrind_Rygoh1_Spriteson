 ...
 * argument, and argv[argc-1] points to the last argument. If argc is 0,
 * the argv parameter is ignored. Otherwise, the argv array should
 * have argc valid null-terminated strings, and it is an error if argv
 * does not.
 *
